...
export abstract class Repository<TEntity extends Record<string, any>, TEntityId> implements IRepository<TEntity, TEntityId> {
    ...
    abstract create<K extends keyof TEntity>(entity: Omit<TEntity, K>, meta: Partial<{ etag: string }>, ...excludedFields: Array<K>): Promise<TEntity | null>
    ...
    abstract update(entity: Partial<TEntity>, meta?: Partial<{ etag: string }>, ...updateFields: Array<keyof TEntity>): Promise<TEntity | null | boolean>
    abstract update<T extends TEntity | null>(entity: Partial<T>, meta?: Partial<{ etag: string }>, ...updateFields: Array<keyof T>): Promise<T | null | boolean>
